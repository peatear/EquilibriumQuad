...
namespace BluetoothConnectionManager
{
    public class btConManager
    {
        ...
        public async Task<uint> SendCommand(float value1, float value2, float sendThrottle)
        {
            ...
            if (dataWriter != null)
            {
                ...
                dataWriter.WriteInt16(Convert.ToInt16(value1));
                dataWriter.WriteInt16(Convert.ToInt16(value2));
                dataWriter.WriteInt16(Convert.ToInt16(sendThrottle));
