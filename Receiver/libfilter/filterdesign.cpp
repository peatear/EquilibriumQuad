...
Platform::Array<float>^ FilterDesign::FIRDesignWindowed( float centerFreq, float bandwidth, WindowType wtype ) {
...
Platform::Array<float>^ FilterDesign::FIRDesignWindowed( float centerFreq, float bandwidth, unsigned int N, WindowType wtype ) {
	// Create an array to store the filter in
	Platform::Array<float>^ filter = ref new Platform::Array<float>(N);
...
Platform::Array<float>^ FilterDesign::createWindow( unsigned int N, WindowType wtype ) {
	// Create an array to store the filter in
	Platform::Array<float>^ window = ref new Platform::Array<float>(N);
