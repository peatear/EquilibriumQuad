...
namespace libfilter
{
    ...
    public:
		...
		[DefaultOverload] Platform::Array<float>^ FIRDesignWindowed( float centerFreq, float bandwidth, WindowType wtype );
		...
		Platform::Array<float>^ FIRDesignWindowed( float centerFreq, float bandwidth, unsigned int length, WindowType wtype );
		...
		Platform::Array<float>^ createWindow( unsigned int N, WindowType wtype );
